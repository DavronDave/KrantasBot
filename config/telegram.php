...
return [
    ...
    */
    'bots' => [
        'mybot' => [
            'token' => env('TELEGRAM_BOT_TOKEN', '5926773484:AAF-bjtZkR775x7yFBH9lw7495In518LVLc'),
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url' => env('TELEGRAM_WEBHOOK_URL', 'https://a446-31-148-166-197.ngrok-free.app'),
            'commands' => [
                //HelpCommand::class,
